...
class Precificacao():
    ...
    def __init__( self ):
        ...
        print(self.PARAMS_DIR)
        self.quarto_area_construida_scaler   = pickle.load( open( os.path.join(self.PARAMS_DIR, "parametrosquartos_por_areaconstruida.pkl"), 'rb') )
        self.preco_por_metro_scaler   = pickle.load( open( os.path.join(self.PARAMS_DIR, 'parametrospreco_por_metro.pkl'), 'rb' ) )
        self.bairro_por_area_scaler   = pickle.load( open( os.path.join(self.PARAMS_DIR,'parametrosbairro_por_area.pkl'), 'rb' ) )
        self.bairro_scaler   = pickle.load( open( os.path.join(self.PARAMS_DIR, 'parametrosbairro_scaler.pkl'), 'rb' ) )
        self.banheiros_scaler   = pickle.load( open( os.path.join(self.PARAMS_DIR, 'parametrosbanheiros_scaler.pkl'), 'rb' ) )
        self.vagas_scaler   = pickle.load( open( os.path.join(self.PARAMS_DIR, 'parametrosvagas_scaler.pkl'), 'rb' ) )
        self.model   = pickle.load( open( os.path.join(self.MODEL_DIR , 'model_price.pkl'), 'rb')  )
